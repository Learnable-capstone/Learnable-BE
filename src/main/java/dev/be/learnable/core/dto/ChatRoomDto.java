...
public class ChatRoomDto {
    ...
    public static ChatRoomDto of(Long memberId, Long subjectId, String title, LocalDateTime createdAt, LocalDateTime updatedAt) {
        return new ChatRoomDto(memberId, subjectId, title, createdAt, updatedAt);
    }

    public static ChatRoomDto of(Long memberId, Long subjectId, String title) {
        return ChatRoomDto.of(memberId, subjectId, title, null, null);
    }
